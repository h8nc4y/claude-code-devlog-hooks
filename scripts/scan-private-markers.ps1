...
$ownRepoUrlPattern = '^https://github\.com/h8nc4y/claude-code-devlog-hooks(?:\.git)?$'
...
$environmentMarkers = [Environment]::GetEnvironmentVariable('CLAUDE_CODE_DEVLOG_HOOKS_PRIVATE_MARKERS')
